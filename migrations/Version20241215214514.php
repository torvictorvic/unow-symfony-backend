 ...
 */
final class Version20241215214514 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE employee (id INT AUTO_INCREMENT NOT NULL, created_by_id INT NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, position VARCHAR(255) NOT NULL, birth_date DATE NOT NULL, created_at DATETIME NOT NULL, email VARCHAR(255) NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_5D9F75A1B03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
